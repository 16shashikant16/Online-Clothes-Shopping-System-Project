					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<form role="form" action="AddProducts" method="post"
								...
								<div class="form-group">
									<label>Clothes Category</label> <select class="form-control"
										name="category"><option>Select Category</option>
										<option>Mens Wear Clothes</option>
										<option>Womens Wear Clothes</option></select>
								</div>
								<div class="form-group">
									<label>Attach Clothes Image</label> <input type="file"
										name="uploadLogo" />
								</div>
